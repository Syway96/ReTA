...
2. 修改 `run_chainlit.bat` 相应路径后，双击运行

### 3.4 添加新内容

默认教材文件标题清晰、无重复（如 `# 1.1`、`# 1.2.1`）
1. 将教材 Markdown 文件放入 `资料库` 目录（或指定路径）
